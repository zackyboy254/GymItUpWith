            ...
            {items.map(item => (
              <div
                ...
                className={`group relative rounded-xl overflow-hidden border transition-all cursor-grab active:cursor-grabbing ${
                  dragOverId === item.id ? 'border-[#FC6129] scale-95' : 'border-white/10'
              ...
              >
                <div className="aspect-square bg-black/60 relative">
                  ...
                  <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                    <button onClick={() => openEdit(item)} title="Edit" className="p-2 bg-white/10 hover:bg-[#FC6129] rounded-lg transition-colors cursor-pointer">
                ...
                <div className="p-2 bg-white/5">
                  ...
                  <p className="text-[9px] text-[#FC6129] mt-0.5 capitalize">{item.category.replace('_', ' ')}</p>
                </div>
              </div>
            ))}
          </div>
