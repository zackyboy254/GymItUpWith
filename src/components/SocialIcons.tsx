...
// Official Bootstrap Icons SVGs (bi bi-instagram, bi-youtube, bi-tiktok, bi-twitter-x)
// ViewBox is set to 0 0 16 16 according to Bootstrap Specs, width/height dynamically scaled.
