...
export default function ScrollToTop() {
    ...
    return (
        <button
            onClick={scrollToTop}
            className={`fixed bottom-24 left-1/2 -translate-x-1/2 z-40 w-12 h-12 rounded-full bg-gradient-to-tr from-[#FC6129] to-[#ff2a2a] flex items-center justify-center text-white shadow-xl shadow-orange-600/30 hover:scale-110 active:scale-95 hover:shadow-orange-600/40 transition-all duration-300 group cursor-pointer ${isVisible
