 ...
 */
export declare function generateRouteStaticParams(segments: ReadonlyArray<Readonly<Pick<AppSegment, 'config' | 'generateStaticParams'>>>, store: Pick<WorkStore, 'fetchCache' | 'page'>, workUnitAsyncStorage: WorkUnitAsyncStorage, isRoutePPREnabled: boolean, rootParamKeys: readonly string[]): Promise<Params[]>;
/**
 * Processes app directory segments to build route parameters from generateStaticParams functions.
 * This function walks through the segments array and calls generateStaticParams for each segment that has it,
 * combining parent parameters with child parameters to build the complete parameter combinations.
 ...
 * @returns Promise that resolves to an array of all parameter combinations
 */
export declare function buildAppStaticPaths({ dir, page, route, distDir, cacheComponents, authInterrupts, segments, isrFlushToDisk, cacheHandler, cacheLifeProfiles, requestHeaders, cacheHandlers, cacheMaxMemorySize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled, partialFallbacksEnabled, buildId, deploymentId, rootParamKeys, }: {
    dir: string;
    page: string;
