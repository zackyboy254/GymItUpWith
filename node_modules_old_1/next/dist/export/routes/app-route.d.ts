...
}, htmlFilepath: string, fileWriter: MultiFileWriter, cacheComponents: boolean, experimental: Required<Pick<ExperimentalConfig, 'authInterrupts'>>, buildId: string, deploymentId: string): Promise<ExportRouteResult>;
